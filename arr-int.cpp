//Activity 6 Dynamic Array Class Template
//Samuel Shard, Student Number: 100745640
#include <string>
#include <cstdlib>
#include <iostream>
using namespace std;
...
int main()
{
    //-------------------------Test DynamicArray Class For Integer
    DynamicArray<int> x;
    ...
    // Output entries
    cout << "Dynamic Array of Integers:" << endl;

    for (int i = 0; i < x.getSize(); i++)
        cout << x.getEntry(i) << endl;

    //-------------------------Test DynamicArray Class For String
